...
{
    globalThis.C3.Plugins.StraniAnelli_InjectCSS.Instance = class StraniAnelli_InjectCSSInstance extends globalThis.ISDKInstanceBase {
        constructor() {
            super();
        ...
        //   await this._triggerAsync(globalThis.C3.Plugins.StraniAnelli_InjectCSS.Cnds.IsCSSAlreadyPresent)
        // }
        //
        // async _IsCSSEnabled() {
        //   await this._triggerAsync(globalThis.C3.Plugins.StraniAnelli_InjectCSS.Cnds.IsCSSEnabled)
        // }
    ...
    var InstanceFunctionsObject = {
        ...
        async InjectElementIntoHead(nameFile, type = "CSS", local = false) {
            if (local) {
                const url = await this.runtime.assets.loadImageAsset(nameFile);
                if (type == "CSS") {
    ...
    for (var k in InstanceFunctionsObject) {
        globalThis.C3.Plugins.StraniAnelli_InjectCSS.Instance.prototype[k] = InstanceFunctionsObject[k];
    }
